...
const addHeroSlide = function () {
  ...
  lastSliderItem.classList.add("activate");
  lastSliderControl.classList.add("activate");
  //activating the first movie slide

  const sliderStart = function () {
    lastSliderItem.classList.remove("activate");
    lastSliderControl.classList.remove("activate");
